...
accelerate launch --config_file $ACCEL_CONFIG --deepspeed_config_file $DEEPSPEED_CONFIG --main_process_port 29002 run_finetuning_lm_rmt.py \
        ...
        --output_dir /home/jovyan/rmt/runs/test/${DATASET_NAME}/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_bptt-${K2}_nfs/run_$N \
