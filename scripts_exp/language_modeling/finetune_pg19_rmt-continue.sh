...
CHECKPOINT=/home/jovyan/rmt/runs/test/pg19/llama32-1b/linear_adamw_wd1e-03_2x1024_mem16_bs32_bptt--1/run_1/checkpoint-37000
...
DEEPSPEED_CONFIG=/home/jovyan/rmt/dev/accel_configs/deepspeed_bf16.json
...
accelerate launch --config_file $ACCEL_CONFIG --deepspeed_config_file $DEEPSPEED_CONFIG --main_process_port 29002 run_finetuning_lm_rmt.py \
        --tokenized_dataset $TASK_DATASET \
        --output_dir /home/jovyan/rmt/runs/test/${DATASET_NAME}/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_bptt-${K2}_continue/run_$N \
