...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29192 run_finetuning_babilong_rmt_qs.py \
        --task_dataset $TASK_DATASET \
        --noise_dataset $NOISE_DATASET \
        --babi_path /home/jovyan/rmt/babilong/data/tasks_1-20_v1-2/en-10k \
        --model_path /home/jovyan/rmt/runs/babilong_multitask/cross_task/${TASK_DATASET}/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs64_bptt-${K2}_eval_qs_from_cpt_${SRC_N_SEGMENTS}x${SEGMENT_SIZE}_eval_mf50_from_dataset_qa1-10/run_$N \
