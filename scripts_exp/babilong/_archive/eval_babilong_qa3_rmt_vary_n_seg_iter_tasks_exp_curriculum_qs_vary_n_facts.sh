...
for MAX_N_FACTS in 5 10 20 30 50 100 200
do
...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29054 run_finetuning_babilong_rmt_qs.py \
        --task_dataset $TASK_DATASET \
        --noise_dataset $NOISE_DATASET \
        --babi_path /home/jovyan/rmt/babilong/data/tasks_1-20_v1-2/en-10k \
        --model_path /home/jovyan/rmt/runs/babilong_vary_n_facts/${TASK_DATASET}/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs64_bptt-${K2}_qs_eval_from_${SRC_N_SEGMENTS}x${SEGMENT_SIZE}_bs1_mf${MAX_N_FACTS}/run_$N \
        --model_cpt /home/jovyan/rmt/runs/babilong_qs/${TASK_DATASET}/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${SRC_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs64_bptt-${K2}_qs_from_cpt_${SRC_SRC_N_SEGMENTS}-${SRC_N_SEGMENTS}/run_$N/model_best \
