...
for MAX_N_FACTS in 5 10 20 30 50 100
do
...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29055 run_finetuning_babilong_rmt.py \
        ...
        --model_path /home/jovyan/rmt/runs/babilong_vary_n_facts/${TASK_DATASET}/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs64_bptt-${K2}_eval_from_${SRC_N_SEGMENTS}x${SEGMENT_SIZE}_bs1_mf${MAX_N_FACTS}/run_$N \
