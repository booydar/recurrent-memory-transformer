...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29005 run_finetuning_babilong_rmt_multitask.py \
        ...
        --model_path /home/jovyan/rmt/runs/babilong_multitask/qa1-10/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs${TBS}_bptt-${K2}_from_cpt_0-1/run_$N \
