...
# for SRC_DATASET in qa1_single-supporting-fact qa2_two-supporting-facts qa3_three-supporting-facts qa4_two-arg-relations qa5_three-arg-relations qa6_yes-no-questions qa7_counting qa8_lists-sets qa9_simple-negation qa10_indefinite-knowledge
# # for SRC_DATASET in qa2_two-supporting-facts
# do
...
echo RUNNING: TASK_DATASET $TASK_DATASET SRC_DATASET $SRC_DATASET MEMORY_SIZE $MEMORY_SIZE SEGMENT_SIZE $SEGMENT_SIZE MAX_N_SEGMENTS $MAX_N_SEGMENTS
echo SAMPLE_SIZE $SAMPLE_SIZE MODEL_NAME $MODEL_NAME  LR $LR N $N
echo gradient accumulation steps $GRAD_ACC_STEPS

accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29102 run_finetuning_babilong_rmt_multitask_qs.py \
        --task_dataset $TASK_DATASET \
        --noise_dataset $NOISE_DATASET \
        --babi_path /home/jovyan/rmt/babilong/data/tasks_1-20_v1-2/en-10k \
        --model_path /home/jovyan/rmt/runs/babilong_multitask/cross_task/qa1-10/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs64_bptt-${K2}_eval_qs_from_cpt_${SRC_N_SEGMENTS}x${SEGMENT_SIZE}_eval_mf50_from_dataset_qa1-10/run_$N \
        --model_cpt /home/jovyan/rmt/runs/babilong_multitask/qa1-10/gpt2/linear_adamw_wd1e-03_${SRC_N_SEGMENTS}x512_mem16_bs64_bptt--1_qs_from_cpt_${SRC_SRC_N_SEGMENTS}-${SRC_N_SEGMENTS}/run_${N}/model_best \
