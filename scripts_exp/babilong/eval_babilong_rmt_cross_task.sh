...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29101 run_finetuning_babilong_rmt_multitask.py \
        --task_dataset $TASK_DATASET \
        --noise_dataset $NOISE_DATASET \
        --babi_path /home/jovyan/rmt/babilong/data/tasks_1-20_v1-2/en-10k \
        --model_path /home/jovyan/rmt/runs/babilong_multitask/cross_task/qa1-10/$MODEL_NAME/${SCHEDULER}_adamw_wd1e-03_${MAX_N_SEGMENTS}x${SEGMENT_SIZE}_mem${MEMORY_SIZE}_bs64_bptt-${K2}_eval_from_cpt_${SRC_N_SEGMENTS}x${SEGMENT_SIZE}_eval_mf50_from_dataset_qa1-10/run_$N \
        --model_cpt /home/jovyan/rmt/runs/babilong_multitask/qa1-10/gpt2/linear_adamw_wd1e-03_${SRC_N_SEGMENTS}x512_mem16_bs64_bptt--1_from_cpt_${SRC_SRC_N_SEGMENTS}-${SRC_N_SEGMENTS}/run_${N}/model_best \
